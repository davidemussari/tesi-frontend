...
import { Directive, NgModule, Input, Output, TemplateRef, ViewContainerRef, EventEmitter, Optional, Injectable, ViewChild, Component, SkipSelf, ɵɵdefineInjectable, ContentChildren, QueryList, HostListener, ElementRef, Renderer2, HostBinding, InjectionToken, ContentChild, Inject, ComponentFactoryResolver, Self, Attribute, Injector, PLATFORM_ID, NgZone, LOCALE_ID, ChangeDetectorRef, IterableDiffers, ChangeDetectionStrategy } from '@angular/core';
